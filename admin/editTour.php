...
<head>
    ...
    <title>Edit Tour #<?php echo $id; ?></title>
...
<h3 class="review_title">edit tour #<?php echo $id; ?></h3>
    <form action="" method="POST">
      <?php 
      $rs_edit = mysqli_query($link, "select * from tour where id=$id");
      ...
      ?>
        ...
        <div data-aos="zoom-in" data-aos-delay="150" class="inputBox">
            <span>Days?</span>
            <input type="text" name="days" onkeypress="return validation(event)" value="<?php echo $row_edit["days"]; ?>">
        </div>
        <div data-aos="zoom-in" data-aos-delay="150" class="inputBox">
            <span>image?</span>
        ...
        <div data-aos="zoom-in" data-aos-delay="150" class="inputBox">
            <span>Price?</span>
            <input type="text" name="price" onkeypress="return validation(event)" value="<?php echo $row_edit["price"]; ?>">
        </div>
        
        <div data-aos="zoom-in" data-aos-delay="300" class="inputBox">
            <span>description?</span>
            <textarea name="description"><?php echo $row_edit["des"]; ?></textarea>
        </div>
        <div data-aos="zoom-in" data-aos-delay="300" class="inputBox">
            <span>places?</span>
            <textarea name="places"><?php echo $row_edit["places"]; ?></textarea>
        </div>

        <div data-aos="zoom-in" data-aos-delay="300" class="inputBox">
            <span>hotels?</span>
            <textarea name="hotels"><?php echo $row_edit["hotel"]; ?></textarea>
        </div>
        <div data-aos="zoom-in" data-aos-delay="300" class="inputBox">
            <span>meals?</span>
            <textarea name="meals"><?php echo $row_edit["meals"]; ?></textarea>
        </div>

        <div data-aos="zoom-in" data-aos-delay="300" class="inputBox">
            <span>travelling?</span>
            <input type="text" value="<?php echo $row_edit["travelling"]; ?>" name="travel">
        </div>
      <?php
      }
      ?>
...
<?php
    ...
    {
        if($_POST["name"] == "" || $_POST["days"] == "" || $_POST["price"] == "" || $_POST["description"] == "" || $_POST["places"] == "" || $_POST["hotels"] == "" || $_POST["meals"] == "" || $_POST["travel"] == ""){
                ?>
                    <script type="text/javascript">
                        swal({
                            title: "Update Tour",
                            ...
                            window.location = "editTour.php?id=<?php echo $id; ?>";
                        });
                    </script>
                <?php
        }
        else
        {
          if($_POST["image"] == "")
          {
            mysqli_query($link, "update tour set name = '$_POST[name]', days = '$_POST[days]', price = '$_POST[price]', des = '$_POST[description]', hotel = '$_POST[hotels]', meals = '$_POST[meals]', travelling = '$_POST[travel]', places = '$_POST[places]' where id = $id");
          }
          else
          {
            mysqli_query($link, "update tour set name = '$_POST[name]', days = '$_POST[days]', price = '$_POST[price]', des = '$_POST[description]', hotel = '$_POST[hotels]', meals = '$_POST[meals]', travelling = '$_POST[travel]', places = '$_POST[places]', image = '$_POST[image]'  where id = $id");
          }
