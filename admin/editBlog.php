...
<?php
    ...
    $rs_img = mysqli_query($link, "select image from blog where id = $id");
...
<head>
    ...
    <title>Edit Blog #<?php echo $id; ?></title>
...
<section class="bookinghome" id="bookinghome">
    ...
    <div class="content">
        <?php 
        $rs_blog = mysqli_query($link,"select * from blog where id = $id");
        while($row_blog = mysqli_fetch_array($rs_blog))
        {
        ?>
            <span data-aos="fade-up" data-aos-delay="150"><?php echo $row_blog["name"]; ?></span>
            <p data-aos="fade-up" data-aos-delay="450">“<?php echo $row_blog["caption"]; ?>”</p>
        <?php
        }
        ?>
    </div>
...
<h3 class="review_title">edit blog #<?php echo $id; ?></h3>
    <form action="" method="POST">
      <?php 
      $rs_edit = mysqli_query($link, "select * from blog where id=$id");
      ...
      ?>
        ...
        <div data-aos="zoom-in" data-aos-delay="150" class="inputBox">
            <span>Caption?</span>
            <input type="text" name="caption" value="<?php echo $row_edit["caption"]; ?>">
        </div>
        <div data-aos="zoom-in" data-aos-delay="150" class="inputBox">
            <span>image?</span>
        ...
        <div data-aos="zoom-in" data-aos-delay="300" class="inputBox">
            ...
            <textarea name="description"><?php echo $row_edit["description"]; ?></textarea>
        </div>
      <?php
      }
      ?>
...
<?php
    ...
    {
        if($_POST["name"] == "" || $_POST["caption"] == "" || $_POST["description"] == "")
        {
                ?>
                    <script type="text/javascript">
                        swal({
                            ...
                            window.location = "editBlog.php?id=<?php echo $id; ?>";
                        });
                    </script>
                <?php
        }
        else
        {
          if($_POST["image"] == "")
          {
            mysqli_query($link, "update blog set name = '$_POST[name]', caption = '$_POST[caption]', description = '$_POST[description]' where id = $id");
          }
          else
          {
            mysqli_query($link, "update blog set name = '$_POST[name]', caption = '$_POST[caption]', description = '$_POST[description]', image = '$_POST[image]' where id = $id");
          }
